...
export function EnquiryQueue({ enquiries, selectedId, onSelect }: Props) {
  return (
    <div>
        ...
        {enquiries.map(enq => (
          ...
          >
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="text-xs font-medium text-gray-900 dark:text-slate-200 truncate">{enq.sender}</span>
            </div>
